...
export default function SliderMain({images}: CorouselProps) {
    ...
    return (
        <div className="relative pb-16">
            <div>
                ...
                <img src="" alt={'Image ${current + 1}'} className="h-[500px] object-cover w-full" />
                {current === 0 && (
                ...
                {current === 1 && (
                    <div className="absolute top-[20%] left-[5%] bg-white p-6 max-w-[450px]">
                        ...
                        <h4 className="text-[1.2rem]">LMBusiness is trusted by 12.5K+ companies around the world. Find out what we can do for yours.</h4>
                    </div>    
                )}
                
                <button onClick={nextImage} className="absolute left-[2%] top-[50%] z-[40]"><BsArrowRight/></button>
